...
function createContainers(){
	...
	//buttons
	var allButton = createButton(plots, 'allButton',params.plotWidth/3 -1, 'Pokemon Popularity', changeHistogram, 'histAll')
	allButton.style('border-right', 'black')
	...
	// var TypeBButton = createButtonon(plots, 'TypeBButton', params.plotWidth/3, 'TypeB', changeHistogram, 'histTypeB')
	...
	var searchInput = search.append('input')
		...
		.style('height',params.buttonHeight + 1-5 + 'px') //not sure why I need the +1 here?
		.style('font-size',params.buttonFontSize + 'px')
		.style('line-height',params.buttonHeight + 'px')
	...
	var searchButton = 	search.append('div')
		...
		.style('height', params.buttonHeight-3 + 'px')
		.on('click', function(){
			checkSearchInput();
		})
	...
	search.append('div')
		...
		.style('float','left')
		.style('height',params.height - params.buttonHeight - 50 + 'px')
		.style('width',params.searchWidth-5 + 'px' )
